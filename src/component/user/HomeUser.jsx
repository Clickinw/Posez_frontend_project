  ...
  return (
    <>
      <div className='container max-w-5xl min-h-screen '>
        ...
        <div className='flex flex-col w-full h-full justify-center content-center items-center mt-10'>
          <button className='my-2 w-[75%] h-[8rem] bg-[#CE3434] hover:bg-[#8D201A] flex  justify-center items-center rounded-md shadow-xl shadow-gray-300 mb-3'>
