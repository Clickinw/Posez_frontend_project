                ...
                <table class="table-fixed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-4 pb-2">178</td>
                      <td className="px-4 pb-2">เผ็ดๆ</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="px-4 pb-2">78</td>
                      <td className="px-4 pb-2">เผ็ดๆ</td>
                    </tr>
                    <tr>
                      <td className="px-4 pb-2">Service Charge</td>
                      <td className="px-4 pb-2"></td>
                      <td className="px-4 pb-2"></td>
                      <td className="px-4 pb-2">7</td>
                      <td className="px-4 pb-2"></td>
                    </tr>
                    <tr>
